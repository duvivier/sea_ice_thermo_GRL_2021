...
#SBATCH -A NCGD0039 
#SBATCH -p dav
#SBATCH -e BL_MOCsig_process.err.%J
#SBATCH -o BL_MOCsig_proces_processs.out.%J
...
export indir=/glade/scratch/dbailey/archive/${casename}/ocn/proc/tseries/month_1/
#export indir=/glade/campaign/cgd/ppc/dbailey/${casename}/ocn/proc/tseries/month_1/
export timestamp="092101-097012"
scriptdir=/glade/p/cgd/ppc/duvivier/cesm2_antarctic_polynya/DATA/data_processing/make_aabw/
#scriptdir=`pwd`
